  ...
  return (
    <main className="min-h-screen p-4 md:p-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold">IP Distance Calculator</h1>
        <Link 
          href="/"
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          {!sessionInfo ? (
            ...
            >
              {loading ? 'Creating link...' : 'Generate IP Distance Link'}
            </button>
          ) : (
            <div className="space-y-4">
              <div className="p-4 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-md">
                <p className="text-green-800 dark:text-green-200 font-medium">Link Created Successfully!</p>
                <p className="text-green-700 dark:text-green-300 text-sm mt-1">
                  Link expires at {formatExpirationTime(sessionInfo.expiresAt)}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                  <li>Share this link with someone else you want to calculate IP distance with.</li>
                  <li>The link is valid for 60 minutes.</li>
                  <li>Only the first two unique IP addresses will be recorded.</li>
                  <li>Once two different IPs visit the link, the distance will be calculated automatically.</li>
                </ol>
              </div>
        ...
        <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
          <h3 className="text-lg font-medium mb-2">About IP Distance</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            The IP Distance tool uses geolocation data from IP addresses to calculate the approximate distance between two internet connections.
          </p>
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900 rounded-md p-4">
            <h4 className="text-blue-800 dark:text-blue-300 font-medium mb-2">Privacy Information</h4>
            <p className="text-blue-700 dark:text-blue-400 text-sm">
              We only collect IP information to calculate the distance. All session data is automatically deleted after 60 minutes.
              No permanent records are kept.
            </p>
          </div>
        </div>
      </div>
