...
export const metadata: Metadata = {
  title: 'IP Distance - Calculate Distance Between IP Addresses | IP Check Tools',
  ...
  keywords: 'ip distance, ip geolocation, ip tracking, distance between ips, ip address distance, location distance',
  openGraph: {
    title: 'IP Distance - Calculate Distance Between IP Addresses',
    description: 'Calculate the geographical distance between two IP addresses in real-time.',
    type: 'website',
    url: 'https://ipcheck.tools/ipdistance',
  },
  alternates: {
    canonical: 'https://ipcheck.tools/ipdistance'
  }
}; 