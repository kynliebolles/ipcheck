          ...
          <div className="mt-8 sm:mt-12 mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-4 max-w-2xl mx-auto">
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200 font-medium" title="Get your precise location information">{t("tools.geolocation_title")}</span>
              </Link>
            </div>
          </div>
